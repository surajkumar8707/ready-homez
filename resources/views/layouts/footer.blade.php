    ...
    <div class="sticky-container">
        <ul class="sticky-social-icons">
            ...
            <li>
                <img alt="Facebook" src="https://avantirealtech.com/images/icon/ftr_scl1.png" width="32"
                    height="32">
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p><span style="color: gold;">{{ getSettings()->app_name }}</span> is a premier property website offering comprehensive real estate services.
                        ...
                        {{ getSettings()->app_name }} is dedicated to helping users make informed decisions and find their ideal
                        property.
                    </p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">{{ getSettings()->address }}</span></li>
                            <li><a href="tel:+91{{ getSettings()->contact }}"><span class="icon icon-phone"></span><span class="text">
                                        {{ getSettings()->contact }}</span></a></li>
                            <li><a href="mailto:{{ getSettings()->email }}"><span class="icon icon-envelope"></span><span
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;
                    <script>document.write(new Date().getFullYear());</script> All rights reserved by {{ getSettings()->app_name }}. Designed by Gaurav Tiwari
...
<div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px">
    ...
    $(window).one('scroll',function() {
     ...
     function closeIcons()
     {
         ...
         $('.intercom.active').html('<img class="img-responsive" src="https://avantirealtech.com/user/images/icon/close.png" alt="intercom-icon">');
