<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ isActiveRoute(['admin.social.media']) }}">
            <a href="{{ route('admin.social.media') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-message-detail"></i>
                <div data-i18n="Analytics">Social Media Links</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ isActiveRoute(['admin.password']) }}">
            <a href="{{ route('admin.password') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-key me-2"></i>
